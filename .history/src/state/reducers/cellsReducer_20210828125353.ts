...
const reducer = produce((state: CellsState = initialState, action: Action) => {
  switch (action.type) {
    ...
    case ActionType.DELETE_CELL:
      ...
      delete state.order.filter(id => id !== action.payload);
    ...
    case ActionType.MOVE_CELL:
      ...
      //(targetIndex is the new index) after finding the index increment or decrement it wrt the direction the user clicks
